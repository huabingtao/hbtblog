...
你好我是一名前端开发。熟练使用**Vue**，了解 Vue**组件化**、**响应式**原理。熟悉**React**，了解其一般使用。熟练**组件化模块化**及**构建优化**，擅长制定并规范团队协作模式。**前后端技术栈**均有尝试能够独立完成项目从零到部署上线。另外我觉得程序员是一条很长的路，因此我还坚持写作，和别的开发者分享自己思考的东西,互相学习。
